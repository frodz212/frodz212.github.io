...
This project is a user driver script that will give current weather forecast from a web API based on a Zipcode, City, or State that is input by the user. 
...
This project is an analysis over GDP data the combines three data sources GDP, Home price, and City (website, csv, api) to understand how the  relatioships between them.
...
This project is an Analysis over Electronic Sale for a company based in the UK to undestand their sales and provide recommendations for improvement.
...
This project is a multilayered exercise that tackles visualizations for different end-users and how to approach presenting to various stakeholders.  
...
This project reviews the methods used in a case study that indetifies students at risk of dropping out. 
